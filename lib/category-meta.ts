...
export const CATEGORY_DEFINITIONS: Record<string, CategoryMeta> = {
  ...
  "Transport & Fuel": {
    ...
    subCategories: [
      "Petrol & Fuel (汽车汽油/打油)",
      "Toll & Parking (过路费/停车)",
      "Car Maintenance (修车/保养)",
      "Grab / Taxi (打车)",
      "Public Transit (公共交通)",
      "Car Insurance & Roadtax (汽车保险/路税)",
    ],
  },
  "Shopping & Groceries": {
  ...
  "Entertainment & Leisure": {
    ...
    subCategories: [
      "Movies & Cinema",
      "Tickets & Passes (门票/票券)",
      "Gaming",
      "Hobbies",
      "Events & Concerts",
      "Outdoor & Sports",
      "Theme Parks & Attractions (游乐园/景点)",
    ],
  },
  "Gambling & Lottery": {
    ...
    defaultBudget: 200,
    subCategories: [
      "Lottery / 4D (万字/彩票/Toto)",
      "Casino (赌场/云顶)",
      "Card & Mahjong (麻将/扑克/牌局)",
      "Sports Betting (球赛博彩)",
      "Lucky Draw & Friendly Bets (聚会抽奖/小赌)",
    ],
  },
  "Healthcare & Medical": {
